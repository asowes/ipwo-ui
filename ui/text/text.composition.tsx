...
import { Text, getTagStyle } from '@asow-core/ipow-ui.text';
    ...
    <ChakraProvider>
      ...
      <div className={HeadingGroup}>
        ...
        <Text tagName="T2-M" isTruncated color={primaryColor}>
          T2-M Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
        <Text tagName="T3-M" isTruncated color={primaryColor}>
          T3-M Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
        <Text tagName="T4-M" isTruncated color={primaryColor}>
          T4-M Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
        <Text tagName="TX1-M" isTruncated color={primaryColor}>
          TX1-M Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
      </div>
      ...
      <div className={HeadingGroup}>
        ...
        <Text tagName="B-1" color={primaryColor}>
          B-1 Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
        <Text tagName="B-2" color={basicColor}>
          B-2 Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
        <Text tagName="B-3" color={basicColor}>
          B-3 Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
      </div>
      <div className={HeadingGroup}>
        ...
        <Text tagName="C-1" color={primaryColor}>
          C-1 Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
        <Text tagName="C-2" color={basicColor}>
          C-2 Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
        <Text tagName="C-3" color={basicColor}>
          C-3 Find fun and interesting projects! Check out our fun family
          projects! Sign up for fun classes and events suitable for all ages and
          skill levels taught by our respected Teachers.
        </Text>
      </div>
